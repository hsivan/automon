...
def _test_neighborhood_size(coordinator, nodes, data_generator, neighborhood_size, sliding_window_size, b_single_sample_per_round):
    ...
    run_test(data_generator, coordinator, nodes, None, sliding_window_size, b_single_sample_per_round)
...
def tune_neighborhood_size(coordinator, nodes, conf, data_generator, b_single_sample_per_round=False):
    ...
    try:
        ...
        violations_stats = _test_neighborhood_size(coordinator, nodes, data_generator, 1.0, conf["sliding_window_size"], b_single_sample_per_round)
        ...
        while violations_stats.neighborhood_violations == 0:
            violations_stats = _test_neighborhood_size(coordinator, nodes, data_generator, violations_stats.neighborhood_size / 2, conf["sliding_window_size"], b_single_sample_per_round)
        ...
        if smallest_neighborhood_size != largest_neighborhood_size:
            ...
            for neighborhood_size in neighborhood_sizes:
                violations_stats = _test_neighborhood_size(coordinator, nodes, data_generator, neighborhood_size, conf["sliding_window_size"], b_single_sample_per_round)
