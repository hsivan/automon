from automon.automon.nodes_automon import NodeCosineSimilarityAutoMon
...
from automon.data_generator import DataGeneratorCosineSimilarity
...
if __name__ == "__main__":
    try:
        ...
        data_generator = DataGeneratorCosineSimilarity(num_iterations=conf["num_iterations"], num_nodes=conf["num_nodes"], d=conf["d"], test_folder=test_folder)
