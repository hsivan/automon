...
if __name__ == "__main__":
    ...
    try:
        ...
        if args.node_idx == -1:
            coordinator = AutomonCoordinator(conf["num_nodes"], func_kld, slack_type=SlackType(conf["slack_type"]), sync_type=SyncType(conf["sync_type"]),
        ...
        if args.node_idx >= 0:
            ...
            node = AutomonNode(args.node_idx, func_kld, domain=conf["domain"], d=conf["d"])
