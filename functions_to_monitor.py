import os
# Can set this environment variable in test to force use AutoGrad, even if Jax exists: os.environ['AUTO_GRAD_TOOL'] = 'AutoGrad'/'Jax'
AUTO_GRAD_TOOL = os.getenv('AUTO_GRAD_TOOL')
# Try import Jax if AUTO_GRAD_TOOL is None (automatic decision, try Jax is exists) or AUTO_GRAD_TOOL is Jax.
...
def func_kld(p_vec):
    ...
    p = P + 1/(200*12)
    q = Q + 1/(200*12)  # sliding_window_size is 200 and num_nodes is 12. TODO: use global variables instead of these hard-coded values
