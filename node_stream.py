...
class NodeStream:
    def __init__(self, num_nodes, sliding_window_size, local_vec_len,
        ...
        for node_idx in range(num_nodes):
            self.sliding_windows.append(Fifo(sliding_window_size, local_vec_len))
    ...
    def set_new_data_point(self, data_point, node_idx):
        self.local_vectors[node_idx] = self.func_update_local_vector(data_point,
                                                                     self.sliding_windows[node_idx],
                                                                     self.local_vectors[node_idx])
