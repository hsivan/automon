...
def plot_dimensions_figures(kld_test_folder, inner_product_test_folder, mlp_test_folder):
    ...
    assert (np.all(dimension_arr_kld == [dim // 2 for dim in dimension_arr_mlp]))
...
if __name__ == "__main__":
    # Figure 6 (a), (b), (c), and (d), in the paper
    kld_test_folder = "../test_results/results_test_dimension_impact_kld_air_quality_2021-07-01_17-14-12"
    inner_product_test_folder = "../test_results/results_test_dimension_impact_inner_product_2021-04-12_15-51-08"
    mlp_test_folder = "../test_results/results_test_dimension_impact_mlp_2021-04-10_09-31-45"
