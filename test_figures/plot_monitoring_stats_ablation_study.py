...
def plot_monitoring_stats_graph_and_barchart(test_folder, func_name):
    ...
    ############# Figure of monitoring stats and barchart of -x_1^2 + x_2^2 #############
    ...
    num_centralization_messages = conf["num_iterations"] * num_nodes
...
def plot_monitoring_stats_barchart(test_folder, func_name):
    ...
    ############# Figure of monitoring stats as barchart of MLP-2 #############
    ...
    # horizontal line indicating Centralization
    num_centralization_messages = num_iterations * num_nodes
