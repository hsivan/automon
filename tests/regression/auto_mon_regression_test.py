...
if __name__ == "__main__":
    try:
        ...
        test_func("entropy", NodeAutoMon, data_generator, conf, test_folder, func_entropy, max_f_val=func_entropy(np.ones(conf["d"], dtype=np.float) / conf["d"]), min_f_val=0.0)
        ...
        test_func("variance", NodeAutoMon, data_generator, conf, test_folder, func_variance, min_f_val=0.0)
        ...
        test_func("inner_product", NodeAutoMon, data_generator, conf, test_folder, func_inner_product)
        ...
        test_func("kld", NodeAutoMon, data_generator, conf, test_folder, func_kld)
        ...
        set_H(conf["d"], H)
        test_func("quadratic", NodeAutoMon, data_generator, conf, test_folder, func_quadratic)
        ...
        test_func("rozenbrock", NodeAutoMon, data_generator, conf, test_folder, func_rozenbrock)
