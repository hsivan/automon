...
def test_func(func_name, NodeClass, data_generator, conf, test_folder, func_to_monitor, max_f_val=np.inf, min_f_val=-np.inf):
    test_func_slack_sync_variations(AutomonCoordinator, func_name, NodeClass, data_generator, conf, test_folder, regression_test_files_folder, func_to_monitor, max_f_val, min_f_val)
...
if __name__ == "__main__":
    try:
        ...
        test_func("entropy", AutomonNode, data_generator, conf, test_folder, func_entropy, max_f_val=func_entropy(np.ones(conf["d"], dtype=np.float) / conf["d"]), min_f_val=0.0)
        ...
        test_func("variance", AutomonNode, data_generator, conf, test_folder, func_variance, min_f_val=0.0)
        ...
        test_func("inner_product", AutomonNode, data_generator, conf, test_folder, func_inner_product)
        ...
        test_func("kld", AutomonNode, data_generator, conf, test_folder, func_kld)
        ...
        test_func("rozenbrock", AutomonNode, data_generator, conf, test_folder, func_rozenbrock)
