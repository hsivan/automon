...
from automon.data_generator import DataGeneratorEntropy, DataGeneratorVariance
from automon.gm.node_entropy_gm import NodeEntropyGM
from automon.gm.node_variance_gm import NodeVarianceGM
from automon.test_utils import start_test, end_test, run_test, get_config
...
if __name__ == "__main__":
    try:
        ...
        data_generator = DataGeneratorEntropy(num_iterations=conf["num_iterations"], num_nodes=conf["num_nodes"], data_file_name=regression_test_files_folder + "data_file_entropy.txt", d=conf["d"])
        ...
        data_generator = DataGeneratorVariance(num_iterations=conf["num_iterations"], num_nodes=conf["num_nodes"], data_file_name=regression_test_files_folder+"data_file_variance.txt")
