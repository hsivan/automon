...
def test_func(func_name, NodeClass, data_generator, conf, test_folder, func_to_monitor):
    ...
    coordinator, nodes = get_objects(NodeClass, RlvCoordinator, conf, func_to_monitor)
...
if __name__ == "__main__":
    try:
        ...
        test_func("kld", RlvNode, data_generator, conf, test_folder, func_kld)
        ...
        test_func("rozenbrock", RlvNode, data_generator, conf, test_folder, func_rozenbrock)
