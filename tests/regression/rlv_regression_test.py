...
from utils.data_generator import DataGeneratorKldAirQuality, DataGeneratorQuadratic, DataGeneratorRozenbrock
from utils.nodes_rlv import NodeKLDRLV, NodeQuadraticRLV, NodeRozenbrockRLV
...
if __name__ == "__main__":
    try:
        ...
        test_func("kld", NodeKLDRLV, data_generator, conf, test_folder)
        ...
        set_H(conf["d"], H)
        test_func("quadratic", NodeQuadraticRLV, data_generator, conf, test_folder)
        ...
        test_func("rozenbrock", NodeRozenbrockRLV, data_generator, conf, test_folder)
